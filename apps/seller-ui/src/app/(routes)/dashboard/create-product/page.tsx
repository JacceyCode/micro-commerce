...
import { enhancements } from "apps/seller-ui/src/utils/AIEnhancement";
...
const Page = () => {
  ...
  const applyTransaformation = async (effect: string) => {
                ...
                <Input
                  ...
                  {...register("short_description", {
                    ...
                    validate: (value) => {
                      ...
                      return (
                        wordCount <= 150 ||
                        `Description cannot excced 150 words (Current: ${wordCount})`
                      );
                    },
                  })}
                />
                ...
                <div className="grid grid-cols-2 gap-3 mx-h-[250px] overflow-y-auto">
                  {enhancements.map(({ label, effect }) => (
                    <button
                      ...
                      onClick={() => applyTransaformation(effect)}
                      disabled={processing}
                    >
                      <Wand size={18} />
                      {label}
