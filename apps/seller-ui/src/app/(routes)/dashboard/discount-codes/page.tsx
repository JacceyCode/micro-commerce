...
import DeleteDiscountCodeModal from "apps/seller-ui/src/shared/components/modals/deleteDiscountCodes";
  ...
  return (
    <div className="w-full min-h-screen p-8">
      <div className="flex justify-between items-center mb-1">
        ...
        <button
          className="bg-blue-600 hover:bg-blue-700 text-whie px-4 py-2 rounded-lg flex items-center gap-2"
              ...
              <div className="mt-2">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <select
                      {...field}
                      className="w-full border outline-none border-gray-700 rounded-md px-3 py-2 text-gray-300 bg-gray-800"
                    >
